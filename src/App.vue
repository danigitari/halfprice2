...
export default {
  ...
  setup() {
    ...
    function getBooks() {
      axios
        .get("https://halfpricedbooks.co.ke/pos/booksApi/api/booksApi.php?limit=50")
        .then((res) => {
          books.value = res.data.data;
          console.log("responseData", books.value);
        })
        .catch((err) => {
          console.log(err);
        });
          ...
          <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
              ...
              <div class="bookory-products-overflow">
                <ul
                  class="bookory-products products columns-4"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div class="elementor-widget-container">
                        <p>
                          Monday – Friday: 9:00-17:00<br />Saturday: 11:00 –
                          15:00
                        </p>
                      </div>
                    </div>
              ...
              <div class="search-by-category input-dropdown">
                <div class="input-dropdown-inner bookory-scroll-content">
                  ...
                  >
                    ...
                    <option class="level-0" value="historical">
                      Historical
                    </option>
                  </select>
